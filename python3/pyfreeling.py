...
class dep_lstm(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, dep_lstm, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, dep_lstm, name)
    __repr__ = _swig_repr

    def __init__(self, fname: 'std::wstring const &'):
        this = _pyfreeling.new_dep_lstm(fname)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _pyfreeling.delete_dep_lstm
    __del__ = lambda self: None

    def analyze(self, *args) -> "freeling::document":
        return _pyfreeling.dep_lstm_analyze(self, *args)
dep_lstm_swigregister = _pyfreeling.dep_lstm_swigregister
dep_lstm_swigregister(dep_lstm)
