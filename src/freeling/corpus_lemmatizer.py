...
news_sections = ['policiales', 'sociedad', 'politica', 'economia']
...
for section in news_sections:
    ...
    for filepath in os.listdir(section_path):
        ...
        for s in ls:
            noun_verb_lemmas = [w.get_lemma() for w in s if w.get_tag()[0] in ('V', 'N')]
